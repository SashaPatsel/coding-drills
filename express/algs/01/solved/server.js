...
function getNumVisits(arr) {
  ...
  var domaninsAndCount = []


  for (var i = 0 ; i < arr.length ; i++) {
    domaninsAndCount.push(arr[i].split(" "))
  }

  

  for (var i = 0 ; i < domaninsAndCount.length ; i++) {

    var visits = parseInt(domaninsAndCount[i][0])
    var domain = domaninsAndCount[i][1]
