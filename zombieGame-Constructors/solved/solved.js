...
var bearHands = new Weapon("Bear Hands", 1, [5, 5], 90, 100000000000000)
var machete = new Weapon("Machete", 1, [40, 60], 90, 5)
var shotgun = new Weapon("Shotgun", 2, [30, 50], 80, 5)
var pistol = new Weapon("Pistol", 1, [25, 40], 85, 5)
var machineGun = new Weapon("Machine Gun", 3, [15, 30], 85, 5)
var sniper = new Weapon("Sniper", 1, [80, 90], 80, 5)
var rpg = new Weapon("RPG", 4, [55, 65], 30, 5)



//Create new instances of zombies
var zombie1 = new Zombie("zombie1", 100, [0, 5], 25)
var zombie2 = new Zombie("zombie2", 90, [1, 6], 28)
var zombie3 = new Zombie("zombie3", 85, [2, 4], 30)
var zombie4 = new Zombie("zombie4", 80, [2, 5], 32)
var zombie5 = new Zombie("zombie5", 60, [7, 10], 20)
...
function Game() {
  ...
  this.fight = function (zombie, weapon) {
    ...
    var allZombies = [zombie1, zombie2, zombie3, zombie4, zombie5]
    var zombieDamSum = 0
    for (var i = 0 ; i < allZombies.length ; i++) {
      allZombies[i].calcDamage(allZombies[i].attack[0], allZombies[i].attack[1])
      allZombies[i].damageBool(allZombies[i].accuracy)

      if (!allZombies[i].didDamage) {
        zombieDamSum+= allZombies[i].roundDamage
      }
    }
